...
class MasternodeScreen extends React.Component {
      ...
      return (
        <ScrollView
          ...
          <TouchableHighlight
            ...
            underlayColor="rgba(73,182,77,1,0.9)"
            onPress={() => this.props.navigation.navigate('Masternode')}
          >
            <View style={styles.rowContainer}>
              <Image
                style={styles.questionIcon}
              ...
              <View style={styles.columnContainer}>
                <View style={styles.rowContainer2}>
                  <View style={styles.textContainer}>
                    <Text style={styles.mainText}>Your masternodes</Text>
          ...
          <View style={styles.rowContainer}>
            <View style={styles.columnContainer}>
              <Text style={styles.mainText}>Signal strenght</Text>
              <Text style={styles.secText}>snni</Text>
            </View>
            <View style={styles.line} />
            <View style={styles.columnContainer}>
              <Text style={styles.mainText}>Updated</Text>
              <Text style={styles.secText}>ago</Text>
            </View>
          </View>
            <FlatList
              vertical
